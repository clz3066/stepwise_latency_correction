...
class SubjectClassify():
    ...
    def training_dataset(self, k, for_training):
        ...
        X = X[shuffle_ix, :].transpose(0, 2, 1)
        y = y[shuffle_ix]
    ...
    def training(self):
        ...
        '''
        self.save_path = '../../results/individual_rnn/{}/{}/{}'.format(self.training_seed, self.task, self.name_in_mat)
        ...
        for self.k in range(10):
            ...
            net = network.RNNClassifier(41, 8, 4, 2).to(DEVICE)
    ...
    def testing_c(self):
        ...
        for testing_seed in range(permutations):
            for step_idx in range(5):
                ...
                self.save_path = '../../results/individual_rnn/{}/{}/{}'.format(testing_seed, self.task, self.name_in_mat)
        ...
        excel_file_path = 'subject_rnn_{}.xlsx'.format(self.task)
    ...
    def testing_s_r(self):
        ...
        data = {'Name': sorted_dict.keys()}
        acc_matrix = np.zeros((len(sorted_dict.keys()), permutations))
        print(sorted_dict)
        for i, value in enumerate(sorted_dict.values()):
            print(i, value)
            acc_matrix[i] = value 
        ...
        excel_file_path = 'subject_{}_rnn_s.xlsx'.format(self.task)
        df.to_excel(excel_file_path, index=False)
