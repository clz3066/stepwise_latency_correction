...
excel_file_path <- "~/Documents/GitHub/latency_variability/results/individual_sem/mvpa_Facc_step4.xlsx"
#excel_file_path <- "~/Documents/GitHub/latency_variability/individual_level/classify/mvpa_Fsp_step0.xlsx"
